...
# Ініціалізація шрифтів після pygame.init()
...
# Завантаження та масштабування заднього фону
background_image = pygame.image.load('images/pacman_background.png').convert()
...
class Menu:
    ...
    def run(self):
        while self.running:
            screen.blit(background_image, (0, 0))  # Відображення заднього фону
            draw_text('Pacman Game', self.font, white, screen, screen_width // 2 - 100, screen_height // 4)

            mx, my = pygame.mouse.get_pos()

            button_1 = pygame.Rect(screen_width // 2 - 100, screen_height // 2, 200, 50)
            button_2 = pygame.Rect(screen_width // 2 - 100, screen_height // 2 + 100, 200, 50)
            ...
            draw_text('Start', self.font, white, screen, screen_width // 2 - 40, screen_height // 2)
            pygame.draw.rect(screen, red, button_2)
            draw_text('Exit', self.font, white, screen, screen_width // 2 - 30, screen_height // 2 + 100)
